...
<body>
    <div class=" vh-100 d-flex justify-content-center align-items-center">
        <form class="border border-primary form-control w-50 p-4" action="uploaded.php" method="post" enctype="multipart/form-data">
            <h2 required class="text-center text-primary font-weight-bold">Add product</h2>
            ...
            <button class="form-control mt-2 btn btn-primary">Add product</button>
        </form>
    </div>
</body>
</html>